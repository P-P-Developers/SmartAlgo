...
function Editclient() {
  ...
  const handleShowAddModal = () => {
    ...
    // console.log("userdata.broker", userdata.licence_type);
    // // if(userdata.licence_type === "1"){
    // //   setLivebrokerErr(' ')
    // // }
  ...
  const getMonthExpired = (sm) => {
    ...
    // console.log("check", dateToday.toLocaleDateString());
      ...
      <div className="content">
        <div className="row">
          <div className="col-md-10">
                  ...
                  <form>
                    ...
                    {userdata.licence_type == 1 ? (
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-2">
                          <div className="form-check">
                            <input type="radio" onChange={e => { inputChange(e) }} checked={checkbroker(2)} className="form-check-input" id="zerodha" name="broker" value="2" disabled={notChangeBroker === 0 ? false : true} />
                        ...
                        <div className="col-md-2">
                          <div className="form-check">
                            <input type="radio" onChange={e => {
                              ...
                              className="form-check-input" id="zebull" name="broker" value="3" disabled={notChangeBroker === 0 ? false : true} />
            ...
            <div className="col-md-2">
           <div className="form-check">
  <input type="radio" onChange={e=>{inputChange(e)}  setLivebrokerErr('')} checked={checkbroker(4)} className="form-check-input" id="angel" name="broker" value="4" />
...
<div className="col-md-2">
           <div className="form-check">
  <input type="radio"  onChange={e=>{inputChange(e)  setLivebrokerErr('')}} checked={checkbroker(7)} className="form-check-input" id="indira" name="broker" value="7" />
                        ...
                        {/* <div className='col-md-6'>
                              <div class="form-group">
                                ...
                                <select
                                  ...
                                  // {...register("group", { onChange: (e) => { groupChange(e) } })}
                                  class="form-control"
                                >
                                  <option value="">Please select group</option>
                                  {group.map((sm, i) => (
