...
const Addclient = () => {
  ...
  const [admin_per, setAdmin_per] = useState(0);
  ...
  const inputChange = (e) => {
    ...
    if (e.target.name == 'licence_type') {
      ...
      if (e.target.value == 2) {
        document.getElementById("license_miss").innerHTML = ""
      }

      if (e.target.value == 2 && admin_per.live == 0 && admin_per.twodays_demo == 1 && roleId == 4) {
    ...
    switch (userdata.broker) {
      ...
      case '22':
        return (
          <>
            <div className="row">
              <p className='text-info'><b>*You should save the mobile number which is registered in the account of Kotak Neo in the mobile number field.</b></p>
              <div className="col-md-3">
              </div>
              <div className="col-md-6">
                <div className="form-group">
  ...
  const handleShowAddModal = () => {
    ...
    if (admin_per.live == 1 && admin_per.twodays_demo == 0 && userdata.licence_type === "1" && roleId == 4) {
      document.getElementById("license_miss").innerHTML = "Please select license"
      return
    }
                ...
                <form id='form'>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group">
                        <label>License</label>
                        <p id='license_miss' style={{ color: "red" }}></p>
                        <select
                          ...
                          {
                            roleId == 4 ?
                              admin_per.live == 1 && admin_per.twodays_demo == 1 ?
                                <>
                                  <option value="1">Demo</option>
                                  <option value="2">Live</option>
                                </>
                                :
                                admin_per.live == 0 && admin_per.twodays_demo == 0 ?
                                  <p>Not permision for add  client</p>
                                  :
                                  admin_per.live == 1 && admin_per.twodays_demo == 0 ?
                                    <>
                                      <option hidden>select license</option>
                                      <option value="2">Live</option>

                                    </>
                                    :
                                    admin_per.live == 0 && admin_per.twodays_demo == 1 ?
                                      <>
                                        <option value="1">Demo</option>
                                        <option value="2">Live</option>
                                      </>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-2">
                          <div className="form-check">
                            ...
                            />
                            <label className="form-check-label" for="swastika">Swastika</label>
                          </div>
                        </div>
                        ...
                        <div className="col-md-2">
                          <div className="form-check">
                            <input type="radio"
                              ...
                              className="form-check-input" id="indira_xts" name="broker" value="24"
                            />
                            <label className="form-check-label" for="indira_xts">Indira XTS</label>
                          </div>
                        </div>
                        ...
                        <div className="col-md-2">
                          <div className="form-check">
                            <input type="radio"
                              ...
                              className="form-check-input" id="icici_direct" name="broker" value="25"
                            />
                            <label className="form-check-label" for="icici_direct">ICICI Direct</label>
                          </div>
                        </div>
                        ...
                        <div className="col-md-2">
                          <div className="form-check">
                            <input type="radio"
                              ...
                              className="form-check-input" id="dhan" name="broker" value="27"
                            />
                            <label className="form-check-label" for="dhan">Dhan</label>
                          </div>
                        </div>
                        ...
                        <div className="col-md-2">
                          <div className="form-check">
                            <input type="radio"
                              ...
                              className="form-check-input" id="upstox" name="broker" value="28"
                            />
                            <label className="form-check-label" for="upstox">Upstox</label>
                          </div>
                        </div>
                        ...
                        <div className="col-md-2">
                          <div className="form-check">
                            <input type="radio"
                              ...
                              className="form-check-input" id="SMC" name="broker" value="30"
                            />
                        ...
                        <div className="col-md-2">
                          <div className="form-check">
                            <input type="radio"
                              ...
                              className="form-check-input" id="adroit" name="broker" value="31"
                            />
                        ...
                        <div className="col-md-2">
                          <div className="form-check">
                            <input type="radio"
                              ...
                              className="form-check-input" id="Shoonya" name="broker" value="32"
                            />
                        ...
                        <div className="col-md-2">
                          <div className="form-check">
                            <input type="radio"
                              ...
                              className="form-check-input" id="Samco" name="broker" value="33"
                            />
