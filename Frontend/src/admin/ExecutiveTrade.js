...
function ExecutiveTrade(e) {
  ...
  function connect(userId, userSession, first_channel, second_channel, openpositionchannel) {
    ...
    socket.onmessage = function (msg) {
      ...
      if (response.s == "OK") {
        ...
        let json = {
          k: "NFO|35019#NFO|35018#" + second_channel + "#" + openpositionchannel,
          t: "t",
        };
        ...
        socket.onmessage = function (msg) {
          ...
          if ("35018" == response.tk && response.lp != undefined) {
            setBankNiftyPriceShow(response.lp)
          }

          if ("35019" == response.tk && response.lp != undefined) {
  ...
  function channeSocket(channel_list, oldlist, openpositionchannel) {
    ...
    let json1 = {
      k: "NFO|35018#NFO|35019#" + channel_list + "#" + openpositionchannel,
      t: "t",
    };
