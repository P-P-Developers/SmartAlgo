...
// const SubadminClients = () => {
//   return (
//     <div>SubadminClients</div>
//   )
// }

// export default SubadminClients
...
function SubadminClients() {
  ...
  // console.log("tradingtable", tradingTableData);
  ...
  const columns = [
    ...
    {
      name: <h6>Sub Admin Username</h6>,
      selector: (row) => row.subAdmin_email,
      width: '270px !important'
    },
    // {
    ...
    {
      name: <h6>Month</h6>,
      selector: (row) => row.twoday_service == 1 && row.license == 0 ? "2 Days" : row.license,
  ...
  useEffect(() => {
    ...
    axios.get(`${Config.base_url}admin/demoClientSubAdmin`, {
      headers: {
        'x-access-token': admin_token
      }, data: {}
    }).then((res) => {
        ...
        if (params.get("client_id") == null) {
          res.data.client.map((cl, i) => {
            data.push({
              ...
              mobile: cl.mobile,
              subAdmin_email: cl.subAdmin_email,
            ...
            // console.log("data", cl.login_status)
          });
        } else {
  ...
  //   axios.get(`${Config.base_url}admin/subadmin/bookdeliverynew`, data).then((res) => {
              ...
              <div className="card-header">
                <div className="row">
                  <div className="col-md-8">
                    <h4 className="card-title">Subadmin Clients</h4>
                  </div>
                  <div className="col-md-2 text-right">
                    <button class=' btn btn-color' onClick={refreshpage}>Go To Clients</button>
                  </div>
                            ...
                            {/* <table>
                              <thead className="tablecolor">
                                <tr>
                                  ...
                                  <th scope="col" className="text-center">Trading</th>
                              ...
                              <tbody>
                                {tradingTableData && tradingTableData.map((item, index) =>

                                  <tr key={index}>
                                    <td className="text-center">{item.username}</td>
                                    <td className="text-center">{item.trading}</td>
