...
function Template(props) {
  ...
  if (roleId === "4" && (pathname == "/admin/message-broadcast" || pathname == "/admin/dashboard" || pathname == "/admin/subadmin" || pathname == "/admin/strategy" || pathname == "/admin/clients" || pathname == "/admin/reports" || pathname == "/admin/transactionlicence")) {
