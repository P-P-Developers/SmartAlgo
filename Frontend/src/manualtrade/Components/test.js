...
function ExecutiveTrad(e) {
  ...
  function connect(userId, userSession, first_channel, second_channel, openpositionchannel) {
    ...
    socket.onmessage = function (msg) {
      ...
      if (response.s == "OK") {
        ...
        let json = {
          k: "NFO|37833#NFO|37834#" + second_channel + "#" + openpositionchannel,
          t: "t",
        };
        ...
        socket.onmessage = function (msg) {
          ...
          if ("37833" == response.tk && response.lp != undefined) {
            setBankNiftyPriceShow(response.lp)
          }

          if ("37834" == response.tk && response.lp != undefined) {
  ...
  function channeSocket(channel_list, oldlist, openpositionchannel) {
    ...
    let json1 = {
      k: "NFO|37833#NFO|37834#" + channel_list + "#" + openpositionchannel,
      t: "t",
    };
      ...
      apiAllRoundToken2 && apiAllRoundToken2.forEach((element1, index1) => {
        ...
        if (element.indexing == index1) {
          ...
          if (element.option_type == "CALL") {
            ...
            var request = "id:11@@@@@input_symbol:" + symbolRef.current + "@@@@@type:" + element.type + "@@@@@price:" + price + "@@@@@dt:1668504000@@@@@qty_percent:100@@@@@order_type:Market@@@@@client_key:" + panelKey + "@@@@@exchange:NFO@@@@@product_type:MIS@@@@@strike:" + element1.strike_price + "@@@@@segment:O@@@@@option_type:" + element.option_type + "@@@@@expiry:" + expiryOnChange + "@@@@@strategy:" + singleStrategy + "@@@@@sq_value:00.00@@@@@sl_value:00.00@@@@@tr_price:00.00@@@@@tsl:00.00@@@@@token:" + element1.call_token + "@@@@@chain:option_chain@@@@@demo:demo";
            ...
            var request = "id:11@@@@@input_symbol:" + symbolRef.current + "@@@@@type:" + element.type + "@@@@@price:" + price + "@@@@@dt:1668504000@@@@@qty_percent:100@@@@@order_type:Market@@@@@client_key:" + panelKey + "@@@@@exchange:NFO@@@@@product_type:MIS@@@@@strike:" + element1.strike_price + "@@@@@segment:O@@@@@option_type:" + element.option_type + "@@@@@expiry:" + expiryOnChange + "@@@@@strategy:" + singleStrategy + "@@@@@sq_value:00.00@@@@@sl_value:00.00@@@@@tr_price:00.00@@@@@tsl:00.00@@@@@token:" + element1.put_token + "@@@@@chain:option_chain@@@@@demo:demo";
            ...
            <div className="">
              ...
              <div className="card-header">
                <div className="row">
                    ...
                    <div>
                      <div className="row">
                        <div className="col-md-4 text-secondary">
                          ...
                          <select
                            name="symbols_filter"
                            className="form-control spacing text-secondary"
                            style={{ width: "100px" }}
                        ...
                        <p className="text-info mb-0"><b>{(singleStrategy != "" && expiryOnChange != "") ? "" : "* Please Select Strategy And Expiry Date To Buy/Sell"}</b></p>
                      </div>
                  ...
                  <div className="col-md-6">
                    <div className="navbar-wrapper text-end d-flex justify-content-end align-items-center">
                      <h5  className="text-secondary">Login with Get Live Price</h5>
                      <Form.Check
                ...
                <div className="row align-items-center mb-2">
                  <div className="col-md-4">
                    <p className="mb-0 text-secondary"><b>BANKNIFTY :- {bankNiftyPriceShow}</b></p>
                  </div>
                  <div className="col-md-4">
                    <p className="mb-0 text-secondary"><b>NIFTY :- {niftyPriceShow}</b></p>
                  </div>
                  <div className="col-md-4">
                      ...
                      {apiAllRoundToken2 && apiAllRoundToken2.map((item, index) => (
                        ...
                        <tr>
                          <td >
                            ...
                            <select
                              name="symbols_filter"
                              className="form-control spacing text-center mx-auto"
                              style={{ width: "100px" }}
                          ...
                          <td style={{ color: colorset(item.call_token), fontWeight: "bold" , background: "none !important" }} className={"showdata" + item.call_token}></td>
                          ...
                          <td>
                            ...
                            <select
                              name="symbols_filter"
                              className="form-control spacing  mx-auto"
                              style={{ width: "100px" }}
