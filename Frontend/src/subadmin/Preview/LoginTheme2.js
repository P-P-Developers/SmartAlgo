    ...
    <div>
        <div className="wrapper " style={{overflowX:'hidden'}}>
				<div id="main-panel" className="" >
					...
					<div class="row ">
					<div className="col-md-6 d-flex justify-content-center img-section-div px-0">
					<div className="text-center">
					
					{/* <h5>Log in now to access</h5> */}
					<img src={`/images/login-img1.png`} className="imgBx"/>
					</div>
					</div>
				...
				<div className="col-md-11 mx-auto">
					<div className="text-center">
					<img style={{ width: "50%" , paddingBottom:'30px',paddingTop:'20px'}} src={`/images/smartalgologo.png`} />
					<p className="form_title">Sign in to your account</p>
						...
						<div className="card-body">
							<form value="Enter" onKeyPress={(e) => submitform(e)} className="login-form">
								...
								<div className="row">
									<div className="col-md-12">
										<button type="button" onClick={(e) => submitform(e)} className="mt-5 thm_btn ">
											Submit
										</button>
									</div>
								</div>
