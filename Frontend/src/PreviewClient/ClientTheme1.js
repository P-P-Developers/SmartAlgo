...
const ClientTheme1 = () => {
    ...
    const submitOtp = (e) => {
        ...
        localStorage.setItem("client_id", userDetails.user_id);
        localStorage.setItem("client_name", userDetails.name);
        // localStorage.setItem("log_in_time",  encode(formattedDateTime));
                                    ...
                                    <div className="card-header">
                                        <div className="row" >
                                            <div className="col-md-11 mx-auto">
                                                <div className="text-center">
                                                    <img style={{ width: "100%", paddingBottom: '10px', paddingTop: '20px' }} src={`/images/${companyDetails && companyDetails[0].image}`} />
                                                </div>
                                            </div>
                                        </div>
                                        <p className="text-center mb-3"><b>Client Login</b></p>
                                    </div>
