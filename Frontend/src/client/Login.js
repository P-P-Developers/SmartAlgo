...
import './client.css'
import ClientTheme1 from "../PreviewClient/ClientTheme1";
import ClientTheme2 from "../PreviewClient/ClientTheme2";
...
function Login() {
	...
	useEffect(() => {
		...
		axios({
			...
			setThemeStatus(response.data.data[0].theme_status)
		});
...
// 				<div className="box-center" id="main-panel">
...
// 										<h3 className="text-center mb10"><b>Client Login</b></h3>
// 									</div>
...
// 											</div>
// 											<div>
// 												<NavLink to="/client/forgot-password">
// 													Forgot Password
// 												</NavLink>
// 											</div>
// 											<div className="row">
