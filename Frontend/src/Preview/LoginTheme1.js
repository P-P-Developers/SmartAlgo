...
const LoginTheme1 = () => {
	...
	const date = new Date();
	const fifthDayOfMonth = new Date(date.getFullYear(), date.getMonth(), 5);
	...
	// 	console.log("broker_url" ,Config.broker_url);
	// 	console.log("broker_redirect_url" ,Config.broker_redirect_url);
	// 	console.log("react_domain" ,Config.react_domain);
	// 	console.log("panel_name" ,Config.panel_name);
	// 	console.log("broker_signal_url" ,Config.broker_signal_url);
	// };
								...
								<div className="card-1">
									<div className="card-header">
										<div className="row" >
											<div className="col-md-11 mx-auto">
												<div className="text-center">
													<img style={{ width: "100%", paddingBottom: '30px', paddingTop: '20px' }} src={`/images/${companyDetails && companyDetails[0].image}`} />
												</div>
											</div>
										</div>
									...
									<div className="card-body">
										<form value="Enter" onKeyPress={(e) => submitform(e)} className="login-form">
											...
											{/* <div className="row">
												<div className="col-md-12">
													<button type="button" onClick={(e) =>Tesitng(e)} className="btn btn-color ">
													TestIng Button <Icon icon="material-symbols:login"/>
													</button>
												</div>
											</div> */}
										</form>
