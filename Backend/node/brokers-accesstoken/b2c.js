           ...
           // res.send(result[0].username);
            ...
            axios(config)
                ...
                .catch(function(error) {
                    ...
                    connection1.query('INSERT INTO `broker_response`(`client_id`,`reject_reason`,`trading_status`,`created_at`) VALUES ("' + user_id + '","' + error.response.data.message + '","Error Not Login","' + ccdate + '")', (err1, signal_status) => {
